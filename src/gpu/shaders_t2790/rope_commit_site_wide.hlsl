// GENERATED by gen_wide_shaders.py from ../shaders/rope_commit_site.hlsl -- do not edit by hand.
...
[numthreads(256, 1, 1)]
void main(uint3 dtid : SV_DispatchThreadID, uint3 gtid : SV_GroupThreadID, uint3 sslm_wide_gid : SV_GroupID)
{
