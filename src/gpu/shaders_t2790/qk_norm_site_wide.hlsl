// GENERATED by gen_wide_shaders.py from ../shaders/qk_norm_site.hlsl -- do not edit by hand.
...
RWByteAddressBuffer SeqStateRows[SSLM_WIDE_H] : register(u0, space1); RWByteAddressBuffer LayerScratchRows[SSLM_WIDE_H] : register(u0, space2); RWByteAddressBuffer KvCache : register(u2); RWByteAddressBuffer WorkScratchRows[SSLM_WIDE_H] : register(u0, space3);
...
void main(uint3 gtid : SV_GroupThreadID, uint3 gid : SV_GroupID) {
    g_row = gid.y;  // T-2790 spike: dispatch row y is sequence row y
