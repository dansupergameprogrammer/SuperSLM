// GENERATED by gen_wide_shaders.py from ../shaders/context_accumulate_site.hlsl -- do not edit by hand.
...
[numthreads(256, 1, 1)]
void main(uint3 dtid : SV_DispatchThreadID, uint3 sslm_wide_gid : SV_GroupID)
{
