// T-2035: gate_proj -- real GPU dispatch, site 12 of 16. ProjectAndFunnel, no
// bias, input=normed (mlp_norm's own output, scratch 0/32), out_channels=
// intermediate_size, weight=gate_weight (Layout[37]).
...
void main(uint3 dtid : SV_DispatchThreadID)
{
    ...
    for (int i5 = 0; i5 < out_channels; ++i5) LayerScratch.Store<int>(336 + i5 * 4, (int)out_codes[i5]);
    LayerScratch.Store<int64_t>(368, out_scale_m);
    LayerScratch.Store<int64_t>(376, out_scale_e);
}
