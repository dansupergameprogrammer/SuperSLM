...
// split out of up_proj_site.hlsl (now requant-only) into its own multi-group dispatch. See
// `down_proj_gemm_site.hlsl`'s own header comment for the full correctness account.
//
