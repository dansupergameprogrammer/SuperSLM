...
cl /nologo /std:c++20 /O2 /W4 /fp:precise /EHsc /Iinclude /Itests /DSUPERSLM_ENABLE_BAD_ALLOC_INJECTION ^
	...
	tests\areas\tokenizer.cpp tests\areas\tensor_manifest.cpp tests\areas\intmath.cpp ^
	/Fo:out\tests\ /c
if errorlevel 1 (
	popd & exit /b 1
)
cl /nologo out\artifact.obj out\sha256.obj out\tokenizer.obj out\model.obj out\intmath.obj out\silu_lut.obj ^
	...
	out\tests\loader.obj out\tests\tokenizer.obj out\tests\tensor_manifest.obj out\tests\intmath.obj ^
