// sslm_marshal.h -- the shared "how an artifact becomes a LayerWeights[]"
// code, extracted from tools/sslm_generate.cpp (T-1684, design
// Claude/Vitruvius/superslm-t1683-layer-bisection-design-2026-08-02.md
// S4.1 step 1) so tools/sslm_generate.cpp and the new tools/sslm_layer_trace.cpp
// (T-1685) share exactly one copy of the artifact-to-LayerWeights[] marshaling
...
#endif  // SUPERSLM_TOOLS_SSLM_MARSHAL_H
