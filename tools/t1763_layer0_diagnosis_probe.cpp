// t1763_layer0_diagnosis_probe.cpp -- T-1763: diagnose why T-1762's downstream int8
// attn_ctx pin (D-SLM77) is violated at layer 0 and holds at every checkpointed deeper
// layer (9, 18, 27).
//
// Built by extending T-1762's own self-checked instrument (tools/t1762_attn_ctx_probe.cpp,
// branch brunel/t1762-attn-ctx-pin@f378049, read not owned -- this is an independent copy,
// not a commit to that branch) in three ways this ticket's brief asks for by name:
//
